echo "Overide Supervisor Configurations"
cp /home/ubuntu/app/supervisord.conf /etc/supervisor/conf.d/supervisord.conf
cp /home/ubuntu/app/supervisord.conf.j2 /etc/supervisor/conf.d/supervisord.conf.j2
